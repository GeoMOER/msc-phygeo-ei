...
shp_names <- list.files(path_lcc_training_areas, 
                        pattern = glob2rx("*.shp"), full.names = TRUE)
shp_names <- shp_names[c(-3, -4)]

shps_cmb(shp_names = shp_names, 
         outfile = paste0(path_lcc_training_areas, "muf_training.shp"))

shp_final <- readOGR(paste0(path_lcc_training_areas, "muf_training.shp"),
                     "muf_training")
...
writeOGR(shp_final, paste0(path_lcc_training_areas, "muf_training.shp"),
