...
if(compute){
  ...
  writeOGR(muf_lc_ta_segm_fields_incl, 
           paste0(path_muf_set1m_lcc_ta, "muf_lc_ta_segm_fields_incl.shp"), 
  ...
  writeOGR(muf_lc_ta_segm_fields_nincl, 
           paste0(path_muf_set1m_lcc_ta, "muf_lc_ta_segm_fields_nincl.shp"), 
           "muf_lc_ta_segm_fields_nincl", driver = "ESRI Shapefile")
} else {
  muf_lc_ta_segm_fields_incl <- 
    readOGR(paste0(path_muf_set1m_lcc_ta, "muf_lc_ta_segm_fields_incl.shp"), 
            "muf_lc_ta_segm_fields_incl")
  muf_lc_ta_segm_fields_nincl <- 
    readOGR(paste0(path_muf_set1m_lcc_ta, "muf_lc_ta_segm_fields_nincl.shp"), 
            "muf_lc_ta_segm_fields_nincl")
}
...
if(compute){
  ...
  saveRDS(muf_lc_ta_segm_fields_nincl_df, 
          file = paste0(path_muf_set1m_lcc_ta, "muf_lc_ta_segm_fields_nincl_df.rds"))
} else {
...
if(compute){
  ...
  saveRDS(muf_lc_ta_segm_fields_incl_df, 
          file = paste0(path_muf_set1m_lcc_ta, "muf_lc_ta_segm_fields_incl_df.rds"))
} else {
...
if(compute){
  ...
  muf_lc_ta_segm_traindata <-readRDS(
    file = paste0(path_muf_set1m_lcc_ta, "muf_lc_ta_segm_traindata.rds"))
}
...
saveRDS(muf_lc_ta_segm_traindata_clean, file = paste0(path_muf_set1m_lcc_ta, 
